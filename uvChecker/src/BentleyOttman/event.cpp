...
Event::Event(int eventType, LineSegment *edgePtrA, Point2D point)
    : eventType(eventType), edgePtrA(edgePtrA), eventPoint(point), sweepline(point.x) {
}

Event::Event(int eventType, LineSegment *edgePtrA, LineSegment *edgePtrB, Point2D point)
    : eventType(eventType), edgePtrA(edgePtrA), edgePtrB(edgePtrB), eventPoint(point), sweepline(point.x) {
}
